...
def dataset_intrinsics(dataset='tartanair'):
    if dataset == "zurich_01" or dataset == "zurich_01_black_calib":
        focalx, focaly, centerx, centery = 766.536, 767.5749, 291.0504, 227.4060
    elif dataset == "vector_01":
        focalx, focaly, centerx, centery = 886.19107, 610.57891, 886.59163, 514.59271
    elif dataset == "davis_3_calib" or dataset == 'davis_9_calib':
        focalx, focaly, centerx, centery = 135.45656932868008, 135.45116899787786, 151.10497292934775, 137.3757405384677
    elif dataset == 'vector_01_calib':
        focalx, focaly, centerx, centery = 676.37735436, 610.08012894, 676.98859289, 515.47925509
    elif dataset == 'm2dgr3_calib':
        focalx, focaly, centerx, centery = 631.35186768, 625.66833496, 327.17070246, 253.11974743
    elif dataset == 'm2dgr3':
        focalx, focaly, centerx, centery = 617.9711, 616.4451, 327.7103, 253.9770
    elif dataset == 'kitti_02':
        focalx, focaly, centerx, centery = 718.856, 718.856, 607.1928, 185.2157
    # elif dataset == 'kitti':
...
def get_camera_matrix_from_intrinsics(focalx, focaly, centerx, centery):
    return np.array([[focalx, 0, centerx], [0, focaly, centery], [0, 0, 1]], dtype=np.float32)
